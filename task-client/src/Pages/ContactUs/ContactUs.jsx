...
const ContactUs = () => {
    ...
    return (
        <div className=''>
        <Helmet><title>TaskZen | ContactUs</title></Helmet>
        <div className="bg-gray-600  flex items-center justify-evenly ">
            {/* <h1 className="md:text-4xl text-3 p-5 font-semibold text-white ">Contact Us</h1>
            <p><span className="text-white">Task Zen</span> {'>'} Contact Us</p> */}
        </div>
        <div className="max-w-[1500px] m-auto mt-52">
            <div>
            ...
            <div className='lg:flex  gap-8  mt-7' >
                <div className='text-lg lg: grow space-y-2 p-5 md:space-y-5'>
                    ...
                    <h1 className='flex items-center gap-3'>
                        <MdEmail></MdEmail>
                        <span className='font-bold'>Email</span>:  info@taskzen.net
                    </h1>
                    <h1 className='flex items-center gap-3'>
                        <MdEmail></MdEmail>
                        <span className='font-bold'>Wechat ID</span>::TaskZen
                    </h1>
                </div>
                {/* this is form */}
                <div className='grow'>
